...
const MiniCounter = ({ orderCount = null, orderId = null }: MiniCounterProps) => {
  ...
  return (
    <div className={styles.mini_counter}>
      <div
        ...
        onClick={() => (orderCount ? calculateCountOneEl('-') : dispatch(decrement()))}
      >
        {renderImageMinus()}
      </div>
      ...
      <div
        ...
        onClick={() => (orderCount ? calculateCountOneEl('+') : dispatch(increment()))}
      >
        {' '}
